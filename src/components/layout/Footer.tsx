...
export const Footer = () => {
  return (
    <footer className="mt-10 flex w-full items-center justify-center bg-blue-50 pt-10">
      <div className="mx-auto flex w-full max-w-7xl flex-col px-4 text-blue-600">
        <div className="w-full text-2xl font-bold md:text-4xl">
          <h2 className="w-full md:w-2/3">
            Як ми можемо вам допомогти? Звяжіться з нами.
          </h2>
        </div>
        <div className="mt-8 flex flex-col md:flex-row md:justify-between">
          <p className="w-full text-zinc-800 md:w-2/3">
            Ми завжди раді Вам допомогти. Залиште нам відгук, повідомлення або
            повідомлення про проблему.
          </p>
          <div className="w-44 pt-6 md:pt-0">
            <a className="flex items-center justify-center rounded-lg bg-blue-600 px-10 py-3 text-center text-white shadow">
              Contact US
            </a>
          </div>
        </div>
        <div className="flex flex-col">
          <div className="mb-12 mt-24 flex flex-row items-center justify-between">
            ...
            <a className="hidden cursor-pointer font-semibold uppercase text-gray-600 hover:text-blue-600 md:block">
              Про Нас
            </a>
            <a className="hidden cursor-pointer font-semibold uppercase text-gray-600 hover:text-blue-600 md:block">
              Services
            ...
            <div className="flex flex-row items-center justify-between space-x-8">
              ...
              <a>
                <svg
                  className="size-8 fill-pink-600"
                  width={12}
                  height={13}
                  viewBox="0 0 12 13"
                  fill="none"
          ...
          <p className="my-12 w-full text-center text-gray-600">
            Copyright © 2025 Budteploizol. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
